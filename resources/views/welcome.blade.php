...
<body class="antialiased bg-gray-50 dark:bg-[#000F0F] text-gray-900 dark:text-gray-100 font-sans overflow-x-hidden transition-colors duration-300">

    {{-- STICKY NAVBAR --}}
    <nav id="navbar" class="fixed top-0 w-full bg-white/80 dark:bg-[#000F0F]/80 backdrop-blur-md border-b border-gray-100 dark:border-[#002525] shadow-sm z-50 transition-all duration-500">
        <div id="navbar-container" class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 transition-all duration-700 ease-in-out">
            <div class="relative flex justify-between h-16 items-center">
                ...
                <div class="hidden md:flex absolute left-1/2 transform -translate-x-1/2 space-x-8 whitespace-nowrap">
                    <a href="#beranda" class="text-gray-600 dark:text-gray-300 hover:text-[#68C7EC] dark:hover:text-[#68C7EC] font-medium transition-colors">Beranda</a>
                    <a href="#fitur" class="text-gray-600 dark:text-gray-300 hover:text-[#68C7EC] dark:hover:text-[#68C7EC] font-medium transition-colors">Fitur Utama</a>
                    <a href="#cara-kerja" class="text-gray-600 dark:text-gray-300 hover:text-[#68C7EC] dark:hover:text-[#68C7EC] font-medium transition-colors">Cara Kerja</a>
                    <a href="#faq" class="text-gray-600 dark:text-gray-300 hover:text-[#68C7EC] dark:hover:text-[#68C7EC] font-medium transition-colors">FAQ</a>
                </div>

                {{-- Bagian Kanan (Tombol) --}}
                <div class="flex-shrink-0 flex items-center gap-2 sm:gap-4 transition-all duration-500">
                    <button id="theme-toggle" type="button" class="text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-[#001818] focus:outline-none rounded-lg text-sm p-2 transition">
                    ...
                    @if (Route::has('login'))
                        <div class="flex items-center space-x-2 sm:space-x-4">
                            @auth
                                <a href="{{ url('/dashboard') }}" class="text-gray-700 dark:text-gray-300 hover:text-[#68C7EC] dark:hover:text-[#68C7EC] font-semibold transition">Dashboard</a>
                            @else
                                <a href="{{ route('login') }}" class="text-gray-700 dark:text-gray-300 hover:text-[#68C7EC] dark:hover:text-[#68C7EC] font-semibold transition hidden sm:inline-block whitespace-nowrap">Masuk</a>
                                @if (Route::has('register'))
                                    <a href="{{ route('register') }}" class="bg-[#68C7EC] hover:opacity-90 text-[#000F0F] px-4 py-2 rounded-md font-bold transition shadow-sm hover:shadow-md whitespace-nowrap">Daftar Gratis</a>
                                @endif
                            @endauth
                        </div>
                    @endif
    ...
    <main id="beranda" class="pt-32 pb-16 mx-auto max-w-7xl px-4 sm:pt-40 sm:px-6 lg:pt-48 text-center reveal-element">
        ...
        <div class="mt-5 max-w-md mx-auto sm:flex sm:justify-center md:mt-8">
            <div class="rounded-md shadow">
                <a href="{{ route('register') }}" class="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-bold rounded-md text-[#000F0F] bg-[#68C7EC] hover:opacity-90 md:py-4 md:text-lg md:px-10 transition hover:-translate-y-1 transform duration-200">
                    Mulai Sekarang
                </a>
            </div>
        </div>
    ...
    {{-- FITUR UNGGULAN --}}
    <div id="fitur" class="py-16 mt-16 bg-white dark:bg-[#001818] transition-colors duration-300 scroll-mt-24 border-t border-gray-100 dark:border-[#002525]">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 text-center pt-4">
                {{-- Fitur 1 --}}
                <div class="p-6 bg-gray-50 dark:bg-[#000F0F] rounded-xl border border-gray-100 dark:border-[#002525] shadow-sm flex flex-col items-center reveal-element delay-100 hover:border-[#68C7EC] dark:hover:border-[#68C7EC] hover:scale-105 hover:-translate-y-2 hover:shadow-2xl dark:hover:shadow-[#68C7EC]/20 hover:z-20 active:scale-95 transition-all duration-300 cursor-pointer">
                    <div class="mb-4 text-[#68C7EC] bg-[#68C7EC]/10 p-3 rounded-full">
    ...
    {{-- CARA KERJA --}}
    <div id="cara-kerja" class="py-20 bg-gray-50 dark:bg-[#000F0F] transition-colors duration-300 scroll-mt-24 border-t border-gray-200 dark:border-[#002525]">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16 reveal-element">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 relative text-center">
                <div class="hidden md:block absolute top-12 left-1/6 right-1/6 h-1 bg-[#68C7EC]/20 dark:bg-[#68C7EC]/10 -translate-y-1/2 z-0 rounded-full"></div>
                <div class="relative z-10 flex flex-col items-center reveal-element delay-100">
                    <div class="w-24 h-24 mb-6 bg-white dark:bg-[#001818] text-[#68C7EC] rounded-full flex items-center justify-center text-3xl font-extrabold border-8 border-gray-50 dark:border-[#000F0F] shadow-md">1</div>
                ...
                <div class="relative z-10 flex flex-col items-center reveal-element delay-200">
                    <div class="w-24 h-24 mb-6 bg-white dark:bg-[#001818] text-[#68C7EC] rounded-full flex items-center justify-center text-3xl font-extrabold border-8 border-gray-50 dark:border-[#000F0F] shadow-md">2</div>
                ...
                <div class="relative z-10 flex flex-col items-center reveal-element delay-300">
                    <div class="w-24 h-24 mb-6 bg-white dark:bg-[#001818] text-[#68C7EC] rounded-full flex items-center justify-center text-3xl font-extrabold border-8 border-gray-50 dark:border-[#000F0F] shadow-md">3</div>
            ...
            <div class="mt-16 text-center reveal-element delay-300">
                <a href="{{ route('register') }}" class="inline-flex items-center justify-center px-8 py-3 border border-transparent text-base font-bold rounded-full text-[#000F0F] bg-[#68C7EC] hover:opacity-90 transition shadow-lg hover:shadow-[#68C7EC]/30 hover:-translate-y-1">
    ...
    {{-- FAQ --}}
    <div id="faq" class="py-20 bg-white dark:bg-[#001818] transition-colors duration-300 scroll-mt-24 border-t border-gray-100 dark:border-[#002525]">
